...
+[[!Build Status][(https://travis-ci.org/Morean92/netguru-junior-recruitment.svg?branch=master)](https://travis-ci.org/Morean92/netguru-junior-recruitment.svg?branch=master)
+
